...
var OpCodeDefs = map[byte]OpCodeDef{
	...
	0x15: {Name: "JUMP", Description: "Jumps to instruction", Op: &UnImplemented{}},
	0x16: {Name: "JUMP_IF_ZERO", Description: "Jump if false", Op: &UnImplemented{}},
	0x17: {Name: "JUMP_IF_NOT_ZERO", Description: "Jump if true", Op: &UnImplemented{}},
	// 0x18 - 0x1F are reserved for more control flow
	0x20: {Name: "EQ", Description: "Checks equality and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
	0x21: {Name: "NE", Description: "Checks NOT equal to and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
	0x22: {Name: "LESS", Description: "Checks less than and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
	0x23: {Name: "LESS_OR_EQ", Description: "Checks less than or equal to and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
	0x24: {Name: "GREATER", Description: "Checks greater than and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
	0x25: {Name: "GREATER_OR_EQ", Description: "Checks greater than or equal and puts 0 on register if false, 1 if true", Op: &UnImplemented{}},
